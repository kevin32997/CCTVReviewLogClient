package gov.zndev.reviewlogclient.helpers.JasperViewer;
...
public class JasperViewerFx extends Dialog<Void> {
    ...
    public JasperViewerFx() {
        ...
        ((Stage) dialogPane.getScene().getWindow()).getIcons().add(new Image("icon.png"));
    ...
    private BorderPane createContentPane() {
        ...
        btnPrint = new Button(null, new ImageView(new Image("printer.png")));
        btnSave = new Button(null, new ImageView(new Image("save.png")));
        btnBackPage = new Button(null, new ImageView(new Image("backimg.png")));
        btnFirstPage = new Button(null, new ImageView(new Image("firstimg.png")));
        btnNextPage = new Button(null, new ImageView(new Image("nextimg.png")));
        btnLastPage = new Button(null, new ImageView(new Image("lastimg.png")));
        btnZoomIn = new Button(null, new ImageView(new Image("zoomin.png")));
        btnZoomOut = new Button(null, new ImageView(new Image("zoomout.png")));
    ...
    private void printAction() {
        btnPrint.setOnAction(event -> {
            ...
            //BufferedImage bufferedImage = SwingFXUtils.fromFXImage(pageToImage(1), null);
